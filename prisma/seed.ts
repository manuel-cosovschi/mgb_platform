...
async function main() {
  ...
  // ──────────────────────────────────────────
  // SIDE PROJECTS LAB — DEMO DATA
  // ──────────────────────────────────────────
  const sideProjectsData = [
    {
      title: "SaaS de reservas para barberías",
      slug: "saas-barberias",
      description: "Sistema de turnos online para barberías con recordatorios automáticos por WhatsApp y panel de administración.",
      problem: "Las barberías gestionan turnos por WhatsApp manual, pierden clientes y tienen noshows constantes.",
      solution: "App web de reservas con confirmaciones automáticas, recordatorios y panel del barbero.",
      audience: "Barberías y peluquerías de Argentina y LATAM",
      type: "SAAS" as const,
      monetization: "Plan básico $15 USD/mes, plan pro $35 USD/mes",
      ...
      investment: "USD 500",
      risk: "LOW" as const,
      stackSuggested: "Next.js, Prisma, Stripe, WhatsApp API",
      observations: "Mercado enorme, poca competencia local. MGB puede venderlo a sus clientes de servicios.",
      ownerId: manuel.id,
      priorityOrder: 1,
    },
    {
      title: "CRM para gimnasios",
      slug: "crm-gimnasios",
      description: "Gestión completa de socios, pagos recurrentes, asistencia y planes de entrenamiento para gimnasios.",
      problem: "Los gimnasios usan Excel o sistemas obsoletos para gestionar socios y pagos.",
      solution: "CRM moderno con gestión de membresías, seguimiento de asistencia y cobros automáticos.",
      audience: "Gimnasios independientes y cadenas pequeñas",
      type: "SAAS" as const,
      monetization: "Suscripción mensual por cantidad de socios activos",
      ...
      stackSuggested: "Next.js, Prisma, MercadoPago",
      observations: "Alta demanda post-pandemia. Posibilidad de alianza con proveedores de equipamiento.",
      ownerId: gabriel.id,
      priorityOrder: 2,
    },
    {
      title: "Tool IA para restaurantes",
      slug: "ai-restaurantes",
      description: "Generador automático de menús optimizados con IA, análisis de costos y sugerencias de precios.",
      problem: "Los restaurantes no saben cuáles platos son más rentables ni cómo optimizar su menú.",
      solution: "IA que analiza ventas, costos y temporadas para sugerir el menú ideal y precios óptimos.",
      audience: "Restaurantes medianos y cadenas de comida",
      type: "AI" as const,
      monetization: "Licencia mensual + consultoría inicial",
      ...
      investment: "USD 2000",
      risk: "MEDIUM" as const,
      stackSuggested: "Python, FastAPI, OpenAI API, Next.js",
      observations: "Requiere integrar IA real. Oportunidad de partnership con proveedores de gastronomía.",
      ownerId: bruno.id,
      priorityOrder: 3,
    },
    {
      title: "Sistema de turnos para clínicas",
      slug: "turnos-clinicas",
      description: "Agendamiento médico online con integración a WhatsApp, recordatorios y gestión de médicos.",
      problem: "Las clínicas pierden horas de staff coordinando turnos por teléfono y tienen alta tasa de ausentismo.",
      solution: "Portal de turnos online con confirmación automática y lista de espera inteligente.",
      audience: "Clínicas privadas, consultorios médicos y centros de diagnóstico",
      type: "APP" as const,
      monetization: "Por cantidad de médicos activos + módulo de videoconsulta",
      ...
      investment: "USD 800",
      risk: "LOW" as const,
      stackSuggested: "Next.js, Prisma, Twilio, Google Calendar API",
      ownerId: manuel.id,
      priorityOrder: 4,
    },
    {
      title: "Dashboard ventas por WhatsApp",
      slug: "dashboard-ventas-whatsapp",
      description: "Métricas, analytics y CRM básico para equipos de ventas que operan 100% por WhatsApp.",
      problem: "Los vendedores por WhatsApp no tienen visibilidad de su pipeline, conversiones ni ingresos.",
      solution: "Dashboard que conecta con WhatsApp Business API y muestra métricas de ventas en tiempo real.",
      audience: "PYMEs con equipos comerciales que venden por WhatsApp",
      type: "TOOL" as const,
      monetization: "Plan por cantidad de agentes + integración premium",
      ...
      investment: "USD 1500",
      risk: "MEDIUM" as const,
      stackSuggested: "Next.js, WhatsApp Cloud API, Recharts, Prisma",
      observations: "Idea directamente relacionada con servicios actuales de MGB. Podría ofrecerse a clientes CRM.",
      ownerId: gabriel.id,
      priorityOrder: 5,
    },
  ];
  ...
  for (const sp of sideProjectsData) {
    await prisma.sideProject.upsert({
      where: { slug: sp.slug },
      update: {},
      create: sp,
    });
  ...
  console.log("✅ Side Projects Lab seeded");
